...
<body>
    ...
    <div class="main-container">
        <section class="flex-center page-top-banner">
            <img src="/public_files/images/accounts_funding/account_funding_top_banner.jpg" alt="Fund Your Account banner" class="mex-img-cover lower-brightness" />
            <div class="container">
                <div class="row">
        ...
        <section class="flex-center page-top-banner">
            <img class="mex-img-cover lower-brightness" src="/public_files/images/accounts_funding/deposit-conditions-bg.jpg" alt="Deposit Conditions">
            <div class="container">
                <div class="row">
