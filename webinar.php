<body>
    ...
    <head>
        ...
        <meta name='description' content="Access and download our Account Forms, including Client Agreement, Financial Services Guide, Product Disclosure Statement, Account Application Forms.">
                ...
                <div class="row nav-bar justify-content-between mx-0">
                    ...
                    <div class="line-height-75 hide-1200 d-flex">
                        <div class="header-bottom-nav">
                            <div class="nav-item"><a class="header-menu-trigger" data-type="about"><?php translate('ABOUT'); ?></a></div>
                            ...
                            <div class="nav-item"><a class="header-menu-trigger" data-type="accounts"><?php translate('ACCOUNTS'); ?></a></div>
                ...
                <ul class="nav-menu py-3">
                        ...
                        <div class="w-75 mx-auto row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="menu_txt_content">
                                    <div class="mex-h2 uppercase mb0 "><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="/about.php"><?php translate('About'); ?></a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 nav-col-hr">
                                <div class="nav-menu-heading">
                                    <h4 class="uppercase mb0"><a class="font-24" href="/about.php"><?php translate('About'); ?></a></h4>
                                </div>
                    ...
                    <li class="nav-products-menu header-nav-menu" style="display: none;">
                        <div class="w-75 mx-auto row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="menu_txt_content">
                                    <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="/products.php"><?php translate('Products'); ?></a>
                                    </div>
                    ...
                    <li class="nav-platforms-menu header-nav-menu" style="display: none;">
                        <div class="w-75 mx-auto row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="menu_txt_content">
                                    <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="/platforms.php"><?php translate('Platforms'); ?></a>
                                    </div>
                    ...
                    <li class="nav-accounts-menu header-nav-menu" style="display: none;">
                        <div class="w-75 mx-auto row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="menu_txt_content">
                                    <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="/account.php"><?php translate('Accounts'); ?></a></div>
                            ...
                            <div class="col-md-4 col-sm-12  col-xs-12 nav-col-hr">
                                <div class="nav-menu-heading">
                                    <h4 class="uppercase mb0"><a class="font-24" href="/account.php"><?php translate('Accounts'); ?></a>
                                    </h4>
                                </div>
                                <ul class="nav-menu-list">
    ...
    <section class="flex-center page-top-banner">
        <div class="container">
            <h2 class="banner-heading color-white text-uppercase">Webinar</h2>
            <div><span>LEARN </span>&nbsp; > <span>&nbsp; WEBINAR</span>
            </div>
    </section>

    <!-- time -->
    <div class="container webinar-time">
        <div class="row">
            <div class="col-3">
                <h3 class="text-uppercase text-gold time-sec-intro">Introduction to MT4</h3>
                <span>28 Aug 2020, Wednesday</span>
            </div>
            <div class="col-5">
                <div class="row" id="countdown">
                    <div class="col-2">
                        <h3 class="text-gold time-digit days"> 00 </h3>
                        <span>days</span>
                    </div>
                    <div class="col-1 time-collon">
                        :
                    </div>
                    <div class="col-2">
                        <h3 class="text-gold time-digit hours"> 00</h3>
                        <span>hours</span>
                    </div>
                    <div class="col-1 time-collon">
                        :
                    ...
                    <div class="col-2">
                        <h3 class="text-gold time-digit minutes"> 00</h3>
                        <span>minutes</span>
                    </div>
                    <div class="col-1 time-collon">
                        :
                    ...
                    <div class="col-3">
                        <h3 class="text-gold time-digit seconds"> 00</h3>
                        <span>seconds</span>
                    </div>
                </div>
            </div>
            <div class="col-4 d-flex align-items-center justify-content-end">
                <h3 class="text-uppercase text-light">join our Upcoming webinar</h3>
            </div>
        </div>
    </div>


    <section class="sec-webinar-list">
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <img src="public_files\images\webinar\computer-man-s-hands-on-notebook.png" />
                </div>
                <div class="col-3">
                ...
                <div class="col-2">
                    <span><i class="far fa-calendar-alt"></i>27 Nov 2020</span>
                    <span><i class="far fa-clock"></i>4:00 - 5:00 PM</span>
                    <span><i class="fas fa-globe-asia"></i><i class="fas fa-globe"></i>GMT Time Zone</span>
                </div>
                <div class="col-2"></div>
                <div class="col-2"></div>
            </div>
    ...
    <script src="/public_files/static_js/jquery-countdown/jquery.countdown.js"></script>
    <script>
        $(document).ready(function() {
            $('#countdown').countdown({
                date: '08/29/2020 23:59:59'
            }, function() {
