        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <div class="swiper-container swiper-container-horizontal" id="swiper-container-awards" style="cursor: grab;">
                    <div class="swiper-wrapper" style="transform: translate3d(-1216.29px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="34" style="width: 115.143px; margin-right: 20px;">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="35" style="width: 115.143px; margin-right: 20px;">
                            <a href="about/awards.php">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="36" style="width: 115.143px; margin-right: 20px;">
                            <a href="about/awards.php">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="37" style="width: 115.143px; margin-right: 20px;">
                            <a href="about/awards.php">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="38" style="width: 115.143px; margin-right: 20px;">
                            <a href="about/awards.php">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="39" style="width: 115.143px; margin-right: 20px;">
                            <a href="about/awards.php">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="40" style="width: 115.143px; margin-right: 20px;">
                            <a href="about/awards.php">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="0" style="width: 115.143px; margin-right: 20px;">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev width-30" data-swiper-slide-index="1" style="width: 115.143px; margin-right: 20px;">
                            <a href="article/multibank-wins-financial-services-provider-asia-award-2019.php">
                                <img class=" lazyloadXXX" src="/public_files/images/about_us/awards/Financial_Services_Provider_of_the_Year_Asia_2019.jpg">
                                <span class="mex-h3 mex-m-b-5 ">Financial Services Provider of the Year (Asia)
                                    2019</span>
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active width-30" data-swiper-slide-index="2" style="width: 115.143px; margin-right: 20px;">
                            <a href="article/multibank-chosen-best-FX-CFD-broker-2019.php">
                                <img class=" lazyloadXXX" src="/public_files/images/about_us/awards/best_fx_broker_euas_2019.png">
                                <span class="mex-h3 mex-m-b-5 ">Best FX &amp; CFD Broker (Europe &amp; Asia)
                                    2019</span>
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next width-30" data-swiper-slide-index="3" style="width: 115.143px; margin-right: 20px;">
                            <a href="article/multibank-wins-ecn-broker-best-forex-platform-2019.php">
                                <img class=" lazyloadXXX" src="/public_files/images/about_us/awards/ecn_broker_eu_2019.png">
                                <span class="mex-h3 mex-m-b-5 ">ECN Broker of the Year (Europe) 2019</span>
                                <span class="mex-content ">International Business Magazine</span>
                            </a>
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="4" style="width: 115.143px; margin-right: 20px;">
                            <a href="article/multibank-wins-ecn-broker-best-forex-platform-2019.php">
                                <img class=" lazyloadXXX" src="/public_files/images/about_us/awards/best_forex_mena_2019.png">
                                <span class="mex-h3 mex-m-b-5 ">Best Forex Platform MENA 2019</span>
                                <span class="mex-content ">International Business Magazine</span>
                            </a>
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="5" style="width: 115.143px; margin-right: 20px;">
                            <a href="article/multibank-named-best-financial-derivatives-broker-2019.php">
                                <img class=" lazyloadXXX" src="/public_files/images/about_us/awards/2019best_financial_derivatives_broker_europe.png">
                                <span class="mex-h3 mex-m-b-5 ">Best Financial Derivatives Broker 2019</span>
                                <span class="mex-content ">Global Banking &amp; Finance Review</span>
                            </a>
                        </div><div class="swiper-slide swiper-slide-duplicate width-30" data-swiper-slide-index="6" style="width: 115.143px; margin-right: 20px;">
                            <a href="article/multibank-selected-best-forex-broker-forex-expo-dubai-2019.php">
                                <img class=" lazyloadXXX" src="/public_files/images/about_us/awards/best_forex_broker_2019.png">
                                <span class="mex-h3 mex-m-b-5 ">Best Forex Broker 2019</span>
                                <span class="mex-content ">The Forex Expo Dubai</span>
