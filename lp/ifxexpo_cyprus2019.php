...
<?php include_from_root("website_templates/head.php")?>
<body>
    <?php include_from_root("website_templates/header.php")?>
    <style>
        .nav-menu-hamburger,
        .nav-menu-mymex {
            width: 35px;
    ...
    <div>
        <div class="d-none d-lg-block">
            <img class="w-100 responsiveload" src="/public_files/images/landing_page/ifx_expo_asia_2019/main_banner.jpg">
        </div>
        <div class="d-block d-lg-none">
            <img class="w-100 responsiveload" src="/public_files/images/landing_page/ifx_expo_asia_2019/main_banner_mobile.jpg">
        </div>
    </div>
    <section class="bg-gray mex-p-t-80">
        <div class="container">
            <h3 class="mex-h1 text-1e32a3 text-center mex-m-b-30">PDF DOWNLOAD</h3>
            <div class="row">
                <div class="col-12 col-md-6 mb-xs-32">
                    <section class="mex-block-card bg-white shadow-box-animate">
                        <div class="card-img-box hover-img-zoom">
                            <img class="card-img mex-img-cover lazyloaded" src="/public_files/images/landing_page/brochure.jpg">
                        </div>
                        <div class="card-content-box">
                            <div class=" card-content bg-white text-center">
                                <div class="mex-h2 uppercase mex-m-b-20 text-overflow-1">Brochure</div>
                                <a href="/public_files/documents/pdf/brochure_v2.pdf" target="_blank" class="btn btn-mex mex-m-b-15 mex-m-t-15">DOWNLOAD</a>
                            </div>
                        </div>
                    </section>
                </div>
                <div class="col-12 col-md-6 mb-xs-32">
                    <section class="mex-block-card bg-white shadow-box-animate">
                        <div class="card-img-box hover-img-zoom">
                            <img class="card-img mex-img-cover lazyloaded" alt="FLYER" src="/public_files/images/landing_page/flyer.jpg">
                        </div>
                        <div class="card-content-box">
                            <div class=" card-content bg-white text-center">
                                <div class="mex-h2 uppercase mex-m-b-20 text-overflow-1">Flyer</div>
                                <a href="/public_files/documents/pdf/Multibank_flyer.pdf" target="_blank" class="btn btn-mex mex-m-b-15 mex-m-t-15">DOWNLOAD</a>
                            </div>
                        </div>
                    </section>
                </div>
    ...
    <section>
        <div class="container page-top-banner">
            <h3 class="mex-h1 text-1e32a3 text-center mex-m-t-50">Booth Map</h3>
            <h3 class="mex-h2 text-center mex-m-b-30">Visit us at Booth: 52</h3>
            <h3></h3>
            <div>
                <div style="position:relative;">
                    <div class="min1" style="display: block;">
                        <img class="w-100 m-auto" src="/public_files/images/landing_page/ifx_expo_asia_2019/floorplan.jpg" alt="Booth Map">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section style="padding-bottom: 40px;">
        <div class="row mx-0">
            <div class="col-lg-6 venue_bg text-fff row align-items-center justify-content-center">
                <div>
                    <h1 class="mex-h1 text-left text-fff">VENUE ADDRESS</h1>
                    <p>Venue: Spyros Kypriannou Athletic Centre, Polemidia, Limassol 3080, Cyprus</p>
                    <strong>Arrange a meeting with us at the iFX Expo</strong>
                    <a style="color: #e2a840;" href="/cdn-cgi/l/email-protection.html#185b4b58556d746c715a7976735e40367b7775"><span class="__cf_email__" data-cfemail="d1b2a291bca4bda5b8b3b0bfbab7a9ffb2bebc">[email&#160;protected]</span></a>
                </div>
            </div>
            <div class="col-lg-6 venue_map_content" id="venue_map">
            </div>
        </div>
    </section>
    <div>
        <div class="mex-h2 text-center mb-4">EXCELLENT OPPORTUNITY FOR FOREX INDUSTRY PROFESSIONALS</div>
        <div>
            <div class="d-none d-lg-block">
                <img class="w-100 responsiveload" src="/public_files/images/landing_page/ifx_expo_asia_2019/hire_now.jpg">
            </div>
            <div class="d-block d-lg-none">
                <img class="w-100 responsiveload" src="/public_files/images/landing_page/ifx_expo_asia_2019/hire_now_mobile.jpg">
            </div>
        </div>
    </div>
    <style>
    ...
    <script type="899407de7614b5a825e574ce-text/javascript">
        function initMap() {
            var myLatLng = {
                lat: 34.714958,
                lng: 32.998601
            ...
            var marker = new google.maps.Marker({
                map: map,
                position: myLatLng,
                title: 'iFX EXPO ASIA 2019'
            });

        }
    </script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAnkDeQhRGNRlj52UXPKIQ_2iUHAqXP7gY&callback=initMap" async defer type="899407de7614b5a825e574ce-text/javascript"></script>
   <?php include_from_root("website_templates/footer.php")?>
    <div class="slidebar">
        ...
        <a class="ib-registration-btn chat-btn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-899407de7614b5a825e574ce-="">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMzowMzowMg==' />
                    <input type='hidden' name='token' value='$2y$10$KRlmvVNrZwLAa2YR7qZgKeYEU8g.FXwyq9aP1hY0ows5i22eH3tbG' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 03:02:35] https://www.multibankfx.com/article/multibank-fx-championship-2019-starting-soon<br/><br/>[2020-06-27 03:02:44] https://www.multibankfx.com/article/hiring-forex-sales-managers-for-dubai<br/><br/>[2020-06-27 03:02:46] https://www.multibankfx.com/article/hiring-forex-sales-managers-for-dubai<br/><br/>[2020-06-27 03:03:02] https://www.multibankfx.com/article/visit-multibank-ifx-cyprus-2019<br/><br/> <br/><br/> posted From: www.multibankfx.com/lp/ifxexpo_cyprus2019?web=true' />
                    ...
                    </div><button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-899407de7614b5a825e574ce-="">SEND</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script src="/public_files/static_js/lang_data/en.js" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script src="/public_files/static_js/jquery.dataTables.min.js" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script src="/public_files/static_js/lazysizes.min.js" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script src="/public_files/static_js/jquery.validate.min.js" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script src="/public_files/static_js/intlTelInput.min.js%3Fversion=20191128" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script src="/public_files/static_js/app.js%3Fversion=20200612" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script type="899407de7614b5a825e574ce-text/javascript" async>
    ...
    <script src="/public_files/static_js/swiper-4.3.5.min.js" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script type="899407de7614b5a825e574ce-text/javascript">
    ...
    <script type="899407de7614b5a825e574ce-text/javascript">
        $(function() {
            ...
            $('.lp-form-submit-btn').click(function() {
                setCookie('form-lp-name', $('.lp-la-form input[name=name]').val(), 1);
                setCookie('form-lp-email', $('.lp-la-form input[name=email]').val(), 1);
                setCookie('form-lp-country', $('.lp-la-form select[name=country] option:selected').val(), 1);
                setCookie('form-lp-phone', $('.lp-la-form input[name=mobile]').val(), 1);
                window.location.href = "/account/live-account.php";
            });
        });
    ...
    <script src="/public_files/static_js/app_home.js" type="899407de7614b5a825e574ce-text/javascript"></script>
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="899407de7614b5a825e574ce-|49" defer=""></script>
</body>
