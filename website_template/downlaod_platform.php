              ...
              <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">             
                ...
                <nav class="nav-1">
                  <div class="nav nav-tabs nav-fill" style="width: 100%;" id="nav-tab" role="tablist">
                    <a class="custom-nav-1-link nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">MT5</a>
                    <a class="custom-nav-1-link nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">MT4</a>
                  ...
                  <div class="container tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row platforms-content">
                      <div class="col-md-4 col-12 mb-3">
                        <div class="card custom-card-platform" style="width:400px">
                          ...
                          <div class="card-body ">
                            ...
                            <div class="flex-container">
                              <ul><li><i class="fa fa-check-circle" aria-hidden="true"></i>Leverage up to 500:1</li>
                            ...
                            <div class="text-center pt-5">
                              <a href="#" class="btn btn-custom-compare">Learn More</a>
