        ...
        <div class="home-banner-container">
            <div class="row">
                ...
                <div class="col-12 d-flex justify-content-center demo-btn-custom ">
                    <div class="row justify-content-center align-items-center flex-column flex-md-row animate__animated animate__bounceInUp animate__delay-1s animate__slow" style="height:100%">
