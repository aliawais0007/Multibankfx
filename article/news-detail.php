            ...
            <div class="row news-container mx-auto">
                <div class="col-12 col-lg-8">
                    <div class="article-container">
                        ...
                        <img src="<?php echo $news->feature_image?>" class="article-img" />
                        <?php echo $news->body?>
                    </div>
                    <style>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMzowMjozMg==' />
                            <input type='hidden' name='token' value='$2y$10$spTEkDuZUjY2WyhqlkXhQexDQDiLxZSD91pqMqfMqu19kARXy.nFu' />
                            <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 03:01:52] https://www.multibankfx.com/article/multibank-malaysia-hosted-successful-trading-seminar-in-kuala-lumpur<br/><br/>[2020-06-27 03:02:16] https://www.multibankfx.com/article/multibank-attends-macau-grand-prix-2019<br/><br/>[2020-06-27 03:02:28] https://www.multibankfx.com/article/multibank-fx-championship-2019-winners-announced<br/><br/>[2020-06-27 03:02:32] https://www.multibankfx.com/article/multibank-mena-diamond-sponsor-jordan-expo<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/news_20170301?web=true' />
                    ...
                    <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12 d-none d-md-block">
                        ...
                        <div style="width: 100%;">
                            <form action="https://www.multibankfx.com/form/callback?" name='call_back_footer_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='call_back_footer_form' target='' autocomplete='on'>
                                <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMzowMjozMg==' />
                                <input type='hidden' name='token' value='$2y$10$drcOFIi6.uVm6DrwF0uCe.aSe7CJoImL2lnetaWu.KP9HU2RvpoKi' />
                                <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 03:01:52] https://www.multibankfx.com/article/multibank-malaysia-hosted-successful-trading-seminar-in-kuala-lumpur<br/><br/>[2020-06-27 03:02:16] https://www.multibankfx.com/article/multibank-attends-macau-grand-prix-2019<br/><br/>[2020-06-27 03:02:28] https://www.multibankfx.com/article/multibank-fx-championship-2019-winners-announced<br/><br/>[2020-06-27 03:02:32] https://www.multibankfx.com/article/multibank-mena-diamond-sponsor-jordan-expo<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/news_20170301?web=true' />
                                <div class='mex-form-item col-6 p-1 cb-partnership font-16 text-center'>
                                    <label for='' class='m-0'>
                                    </label>
                                ...
                                <div class='mex-form-item col-6 col-md-6 p-1 send-code-container'>
                                    <button class='btn btn-mex w-100 h-40p send-verification-code-btn min-w-unset ' id='button-send-callme_form' type='button' title='Send Code'>Send Code</button>
                                </div><button type='submit' class='btn btn-mex mx-auto' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-="">CALL ME</button>
                            </form>
                            <div class="px-1 font-10" style="padding:0px;">
                                <div class="form-check form-check-inline">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMzowMjozMg==' />
                    <input type='hidden' name='token' value='$2y$10$nV6wRBuguYxT2CktsFwP4esXqZa9aZmsChshkTomWyzvWWZELNBM.' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 03:01:52] https://www.multibankfx.com/article/multibank-malaysia-hosted-successful-trading-seminar-in-kuala-lumpur<br/><br/>[2020-06-27 03:02:16] https://www.multibankfx.com/article/multibank-attends-macau-grand-prix-2019<br/><br/>[2020-06-27 03:02:28] https://www.multibankfx.com/article/multibank-fx-championship-2019-winners-announced<br/><br/>[2020-06-27 03:02:32] https://www.multibankfx.com/article/multibank-mena-diamond-sponsor-jordan-expo<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/news_20170301?web=true' />
