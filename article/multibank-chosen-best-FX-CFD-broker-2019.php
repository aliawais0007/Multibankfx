...
<body>
            ...
            <div class="row news-container mx-auto">
                <div class="col-12 col-lg-8">
                    <div class="article-container">
                        <article>
                            <header>
                                <h1 class="article-title">MultiBank Chosen as Best FX & CFD Broker (Europe & Asia) 2019
                                    by
                                    International Investor Magazine</h1>
                                <div class="article-date">2019-05-27 | News</div>
                            </header>
                        </article>
                        <div class="article-body">
                            <p class="article-date"></p>
                            <img src="../public_files/images/blog/news_best_fx_cfd_broker_europe_asia_2019.jpg" class="article-img" />
                            <p class="article-paragraph">
                                <p class="MsoNoSpacing"><span lang="EN-US">27<sup>th</sup>
                                        May 2019-</span></p>
                                <p class="MsoNoSpacing"><span class="c8083">This week
                                        MultiBank Group was awarded the title “Best FX & CFD Broker (Europe &
                                        Asia) 2019” by International Investor Magazine. The online publication, which provides
                                        news and insights on topics ranging from world markets, investing opportunities
                                        to industry analysis, named MultiBank, along with others, winners of the 2019
                                        International Investor Awards in its Spring Issue.</span></p>
                                <p class="MsoNoSpacing"><span class="c8112">In relation to
                                        the award, International Investor Magazine states, “In the name of recognising
                                        excellence in all areas, we select champions from a wide range of businesses
                                        for our awards ….[who] display first rate service, opportunity, innovation and
                                        performance. Organisations that drive forward the world of international
                                        business.”</span></p>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoxNQ==' />
                            <input type='hidden' name='token' value='$2y$10$93/.zj4nmRr.qFQgH2TBi.zyUTP6t7a7Nr0uA0JNxAU1O.XP1IeRa' />
                            <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:00] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:01] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:13] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:15] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-chosen-best-FX-CFD-broker-2019?web=true' />
                            ...
                            <button type='submit' class='btn-contact mx-1 mt-2 mb-0' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-dfdf490f981b00becc572030-="">SUBMIT
                            </button>
                        </form>
    ...
    , <a href="../cookie-policy.html" target="_blank" class="text-22A0C4" style="padding:0 !important;">และนโยบายคุกกี้</a>.'>By
                    ...
                    <div class="mex-h5 text-1e32a3 text-center c859">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            <a href="multibank-named-best-financial-derivatives-broker-2019.html" class="thumbnail-frame col-6 px-0">
                                <img src="../public_files/blog/thumbnails/news_best_financial_derivatives_broker_2019_thumbnail.jpg" class="side-news-thumbnail" />
                            </a>
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-named-best-financial-derivatives-broker-2019.html" class="text-left article-thumbnail-text c1001">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-gold-exhibitor-poland-invest-cuffs-2019.html" class="text-left article-thumbnail-text c1066">
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="../cdn-cgi/l/email-protection.html#beddcdfed3cbd2cad7dcdfd0d5d8c690ddd1d3">
            <span class="btn"> <img alt="email" data-entity-type="" data-entity-uuid="" src="../public_files/images/home/sidebar_icon/email.png" width="50" /> </span>
        </a>
        <a class="ib-registration-btn chat-btn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-dfdf490f981b00becc572030-="">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoxNg==' />
                    <input type='hidden' name='token' value='$2y$10$XiJFvWcDdxzjQPCkgSLo2eAicD.Gf4vqd3RfdYu4bHWdh1hksA3lO' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:00] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:01] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:13] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:16] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-chosen-best-FX-CFD-broker-2019?web=true' />
                    ...
                    <button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-dfdf490f981b00becc572030-="">SEND
                    </button>
                </form>
            </div>
        </div>
    ...
    <script type="dfdf490f981b00becc572030-text/javascript">
        $(function() {
    ...
    <script src="../public_files/static_js/lang_data/en.js" type="dfdf490f981b00becc572030-text/javascript"></script>
    <script src="../public_files/static_js/jquery.dataTables.min.js" type="dfdf490f981b00becc572030-text/javascript"></script>
    <script src="../public_files/static_js/lazysizes.min.js" type="dfdf490f981b00becc572030-text/javascript"></script>
    <script src="../public_files/static_js/jquery.validate.min.js" type="dfdf490f981b00becc572030-text/javascript"></script>
    <script src="../public_files/static_js/intlTelInput.min.js%3Fversion=20191128" type="dfdf490f981b00becc572030-text/javascript"></script>
    <script src="../public_files/static_js/app.js%3Fversion=20200612" type="dfdf490f981b00becc572030-text/javascript"></script>
    <script type="dfdf490f981b00becc572030-text/javascript" async>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="dfdf490f981b00becc572030-|49" defer=""></script>
</body>
