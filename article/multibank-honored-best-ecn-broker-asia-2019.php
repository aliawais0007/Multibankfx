...
<body>
            ...
            <div class="row news-container mx-auto">
                <div class="col-12 col-lg-8">
                    <div class="article-container">
                        <article>
                            <header>
                                <h1 class="article-title">Finance Derivative Honors MultiBank Group as “Best ECN Broker of the Year
                                    (Asia) 2019”</h1>
                                <div class="article-date">2019-04-30 | News</div>
                            </header>
                        </article>
                        <div class="article-body">
                            <p class="article-date"></p>
                            <img src="https://cms.multibankfx.com/public_files/images/blog/news_best_ecn_broker_of_the_year_asia_2019.jpg" class="article-img" />
                            <p class="article-paragraph">
                                <p class="MsoNoSpacing">30<sup>th</sup> April 2019-
                                </p>
                                <p class="MsoNoSpacing"><span class="c8278">On 30</span><sup class="c8287">th</sup><span class="c8296"> April 2019, the global financial and business
                                        analysis magazine Finance Derivative announced that MultiBank Group has won the
                                        title “Best ECN Broker of the Year (Asia) 2019”. The announcement will be made
                                        public on the December 2019 edition of their print magazine, along with other
                                        winners of from different award categories.</span></p>
                                <p class="MsoNoSpacing">MultiBank was chosen as the best ECN broker in Asia due to its widely
                                    popular MT4 & MT5 ECN trading platforms. With MultiBank’s 100% transparent
                                    ECN technology, clients get direct access to the market while enjoying the
                                    lowest spreads and fastest order execution. MultiBank’s ECN platform has been
                                    widely popular particularly to its clients in Asia, where over 60% of clients
                                    are trading with MultiBank’s ECN Pro platform.</p>
                                <p class="MsoNoSpacing"><span lang="EN-US"><a href="../platforms/ecn-pro.html">
                                            <span lang="EN-HK" class="text-22A0C4">Learn more about MultiBank’s ECN Pro platform</span></a></span>
                                </p>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoyMQ==' />
                            <input type='hidden' name='token' value='$2y$10$XGQpTtML4nfUete9xY0zd.hy9Mm8WFFrpylc7g.tF8X3cGmVCF9jq' />
                            <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:18] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:19] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:20] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:21] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-honored-best-ecn-broker-asia-2019?web=true' />
    ...
    , <a href="../cookie-policy.html" target="_blank" class="text-22A0C4" style="padding:0 !important;">และนโยบายคุกกี้</a>.'>By submitting this form, you agree to accept the <a href="../terms-conditions.html" target="_blank" class="text-22A0C4" style="padding:0 !important;">Terms &amp; Conditions</a>, <a href="../privacy-policy.html" target="_blank" class="text-22A0C4" style="padding:0 !important;">Privacy Policy</a>, and <a href="../cookie-policy.html" target="_blank" class="text-22A0C4" style="padding:0 !important;">Cookie Policy</a>.
                    ...
                    <div class="mex-h5 text-1e32a3 text-center c859">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            <a href="news_20181217.html" class="thumbnail-frame col-6 px-0">
                                <img src="../public_files/blog/thumbnails/news_20181217_t_0.jpg" class="side-news-thumbnail" />
                            </a>
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="news_20181217.html" class="text-left article-thumbnail-text c933">MultiBank Showcases Superior Trading Platform & Fintech Solutions at Shanghai Money Fair
                                </a>
                                <div class="text-left article-thumbnail-text">2018-12-17
                                </div>
                            </div>
                        </div>
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-attends-forex-expo-dubai-wins-best-forex-broker.html" class="text-left article-thumbnail-text c1001">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="news_20171216.html" class="text-left article-thumbnail-text c1131">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            <a href="multibankfx-asia-roadshow-kuala-lumpur.html" class="thumbnail-frame col-6 px-0">
                                <img src="../public_files/blog/thumbnails/news_20190222_thumbnail_0.jpg" class="side-news-thumbnail" />
                            </a>
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibankfx-asia-roadshow-kuala-lumpur.html" class="text-left article-thumbnail-text c1196">
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="../cdn-cgi/l/email-protection.html#c4a7b784a9b1a8b0ada6a5aaafa2bceaa7aba9">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoyMQ==' />
                    <input type='hidden' name='token' value='$2y$10$A0IXqUgUckGEU0pA8gluFOK5yEFKVE6j3oV220XzuIlwpUWZB6KVa' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:18] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:19] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:20] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:21] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-honored-best-ecn-broker-asia-2019?web=true' />
