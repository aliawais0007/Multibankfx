...
<body>
            ...
            <div class="row news-container mx-auto">
                <div class="col-12 col-lg-8">
                    <div class="article-container">
                        <article>
                            <header>
                                <h1 class="article-title">MultiBank FX Championship Starting Soon! USD 12,000 CASH
                                    Giveaway to Top 3
                                    Demo Contest Winners</h1>
                                <div class="article-date">2019-08-13| News</div>
                                <br />
                            </header>
                        </article>
                        <img src="https://cms.multibankfx.com/../../../public_files/images/blog/championship_en.jpg" class="article-img" />
                        <div class="article-body">
                            <p class="article-date"></p>
                            <p class="article-paragraph">
                                <div>
                                    <p class="MsoNormal"><span lang="EN-US">Join MultiBank FX Championship, our one-month long demo trading competition for a chance to win CASH prizes of USD 12,000 total. Sign up today!</span>
                                    </p>
                                    <ul class="c109644" style="padding-left: 2.5vmax; list-style: disc">
                                        <li>Join for free</li>
                                        <li>Zero deposit required</li>
                                        <li>Trade on demo account</li>
                                        <li>No strings attached</li>
                                    </ul>
                                    <p><b>Prizes</b></p>
                                    <p class="MsoNormal"><span lang="EN-US">The top 3 winners from MultiBank FX Championship will win the following prizes:</span>
                                    </p>
                                    <ul class="c109644" style="list-style: none">
                                        <li>1st Place: US $7,000 CASH</li>
                                        <li>2nd Place: US $3,000 CASH</li>
                                        <li>3rd Place: US $2,000 CASH</li>
                                    </ul>
                                    <p><b>Schedule</b></p>
                                    <ul class="c109644" style="list-style: none">
                                        <li>Registration Period: September 2 – September 29, 2019</li>
                                        <li>Competition Period: September 30 – October 25, 2019 (4 weeks)</li>
                                    </ul>
                                    <p class="MsoNormal"><span lang="EN-US">Top 3 winners will be announced the first week of November 2019</span>
                                    </p>
                                    <div class="text-left mex-m-b-20 c109692"><a href="../demo_competition.html" class="c109553 btn btn-mex" style="background: #17A42F; border-color: #17A42F;">Join
                                            MultiBank FX Championship</a></div>
                                </div>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDozMw==' />
                            <input type='hidden' name='token' value='$2y$10$vaq7l2ZC0qZXna6rtbaadeYCHdMxLLtyGjPaQR1wQ1/4a3buDQ856' />
                            <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:29] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:30] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:31] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:33] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-fx-championship-2019-starting-soon?web=true' />
                    ...
                    <div class="mex-h5 text-1e32a3 text-center c859">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-honored-best-ecn-broker-asia-2019.html" class="text-left article-thumbnail-text c933">Finance Derivative Honors MultiBank Group as
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="../cdn-cgi/l/email-protection.html#b0d3c3f0ddc5dcc4d9d2d1dedbd6c89ed3dfdd">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDozMw==' />
                    <input type='hidden' name='token' value='$2y$10$fTFHjoLIPafsAinlAowqte3C.yA5qzLPwoUtazLLy96OXRGeqOD3i' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:29] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:30] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:31] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:33] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-fx-championship-2019-starting-soon?web=true' />
