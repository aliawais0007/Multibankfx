            ...
            <div class="row news-container mx-auto">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="article-container">
                        <article>
                            <header>
                                <h1 class="article-title">MultiBank Makes an Appearance at the iFX Cyprus Expo</h1>
                                <div class="article-date">2019-05-22 | News</div>
                            </header>
                        </article>
                        <div class="article-body"><img src="http://cms.multibankfx.com/../../../public_files/images/blog/ifx-cyprus_1200x630.jpg" class="article-img" />
                            <p class="article-date"></p>
                            <p class="article-paragraph"></p>
                            <p class="c28524"><span lang="EN-US" class="c28532">22<sup>nd</sup> May 2019 (Limassol, Cyprus)—</span>
                            </p>
                            <p class="c28589"><span lang="EN-US" class="c28597">On 22<sup>nd</sup> and 23<sup>rd</sup> May,
                                    the industry’s largest financial trading expo took place at Palais des Sports,
                                    Spyros Kypriannou Athletic Centre. The two-day event saw over a thousand
                                    exhibitors, and hundreds of attendees visited this popular annual expo in
                                    Cyprus, with attendees coming from Europe and Middle East.</span></p>
                            <p class="c28672"><span lang="EN-US" class="c28680">MultiBank enjoyed a great turnout, as staff
                                    engaged with individual investors, Liquidity Providers, Marketing, and Payment
                                    Solution Providers from across the European Region.</span></p>
                            <p class="c28719"><span lang="EN-US" class="c28727">During the expo, MultiBank’s MENA (Dubai) office
                                    team held various conferences & workshops in discussing a wide range of
                                    topics from modern Salesforce within the FX industry to keeping at the
                                    forefront of technology, and the hot topic of data licensing and compliance.
                                </span></p>
                            <p class="c28766"><span lang="EN-US" class="c28774">As we embark on the last two quarters of
                                    2019, we would like to thank everyone who visited our booth during the expo. This
                                    was our MENA team’s first appearance at Cyprus and we look forward to coming
                                    back again next year.  Stay tuned for more events and seminars in
                                    2019.  Follow us on social media for the latest news.</span></p>
                            <p></p>
                            <video allowfullscreen="allowfullscreen" class="article-video" controls="controls" poster="multibank-makes-appearance-ifx-cyprus-expo.html" src="../public_files/images/blog/ifxCyprus.mp4">&nbsp;</video>
                        </div>
                    </div>
                    <style>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDozOA==' />
                            <input type='hidden' name='token' value='$2y$10$5vuxfiJo41BaCt6kyupUYuhOMHoNkaRy0YMStnxru4LHeNX6g7.mC' />
                            <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:35] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:36] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:37] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:38] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-makes-appearance-ifx-cyprus-expo?web=true' />
                    ...
                    <div class="mex-h5 text-1e32a3 text-center c859">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-philippines-hosts-investors-night-2019.html" class="text-left article-thumbnail-text c933">MultiBank Philippines Hosts Investors Night 2019
                                </a>
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-attends-macau-grand-prix-2019.html" class="text-left article-thumbnail-text c1001">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-chosen-best-FX-CFD-broker-2019.html" class="text-left article-thumbnail-text c1066">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            <a href="forexexpo_dubai2019.html" class="thumbnail-frame col-6 px-0">
                                <img src="../public_files/blog/thumbnails/dubai_expo_thumbnail_465x265.jpg" class="side-news-thumbnail" />
                            </a>
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="forexexpo_dubai2019.html" class="text-left article-thumbnail-text c1196">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDozOA==' />
                    <input type='hidden' name='token' value='$2y$10$UpcTy8mNinu1zgctR3Y6ruypxCn6AiOtXrZ7BddVDzUysDM0ZxzU.' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:35] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:36] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:37] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:39] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-makes-appearance-ifx-cyprus-expo?web=true' />
