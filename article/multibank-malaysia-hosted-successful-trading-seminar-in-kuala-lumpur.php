...
<body>
            ...
            <div class="row news-container mx-auto">
                <div class="col-12 col-lg-8">
                    <div class="article-container">
                        <article>
                            <header>
                                <h1 class="article-title">MultiBank Malaysia Hosted Successful Trading Seminar in Kuala Lumpur
                                </h1>
                                <div class="article-date">2019-11-17 | News</div>
                            </header>
                        </article>
                        <img src="https://cms.multibankfx.com/../../../public_files/images/blog/malaysia_seminar_en.jpg" class="article-img" />
                        <div class="article-body">
                            <p class="article-date"></p>
                            <p class="article-paragraph">
                                <p class="MsoNormal">17<sup>th</sup> November, 2019 (Kuala Lumpur, Malaysia)-
                                </p>
                                <p class="MsoNormal">On Sunday 17<sup>th</sup>
                                    November, MultiBank Malaysia hosted an educational trading seminar at the
                                    picturesque Bangi Golf Resort in Kuala Lumpur. The event was attended by over
                                    one hundred enthusiastic traders interested in learning about MultiBank Group
                                    and the trading opportunities it offers.
                                </p>
                                <p class="MsoNormal">During the event,
                                    participants were introduced to the Group, the award-winning trading platforms
                                    and special trading conditions tailored to the Malaysian market. Two special
                                    guest speakers were present: Mr. Ahmad Faizuddin, editor-in-chief of the online
                                    magazine "Majalah Forex Malaysia" who spoke about fundamental and
                                    technical analysis and Mr. Casper Tang, first place winner of the most recent
                                    MultiBank FX Championship demo trading competition, who spoke about the
                                    importance of controlling ones emotions during trading.
                                </p>
                                <p class="MsoNormal">MultiBank
                                    Management Team believes that the Malaysian market is of strategic importance
                                    to the expansion of the Group and plans to host a series of seminars with
                                    industry-favorite guest speakers to discuss topics such as innovation and
                                    tactics in financial trading in the upcoming year.
                                </p>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoyNw==' />
                            <input type='hidden' name='token' value='$2y$10$5gMXZjm/kUnZPR0jnOJtbeHJOCn4/rbM3pWmsETpwrQa7.Gtj4E.2' />
                            <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:24] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:25] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:26] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:27] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-malaysia-hosted-successful-trading-seminar-in-kuala-lumpur?web=true' />
                    ...
                    <div class="mex-h5 text-1e32a3 text-center c859">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="news_20180209.html" class="text-left article-thumbnail-text c933">MultiBank Group – Connecting the World Financial Markets
                                </a>
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="forexexpo_dubai2019.html" class="text-left article-thumbnail-text c1131">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="artur-filipowicz-joins-multibank-head-institutional-sales.html" class="text-left article-thumbnail-text c1196">
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="../cdn-cgi/l/email-protection.html#d8bbab98b5adb4acb1bab9b6b3bea0f6bbb7b5">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoyNw==' />
                    <input type='hidden' name='token' value='$2y$10$YNcPrXFO2lDISn13aUjPn.hSYhlfGQ6x0RYZRjWGU/jWlZisSkKwK' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:24] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:25] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:26] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:27] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-malaysia-hosted-successful-trading-seminar-in-kuala-lumpur?web=true' />
