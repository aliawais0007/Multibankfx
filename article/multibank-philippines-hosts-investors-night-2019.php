...
<body>
            ...
            <div class="row news-container mx-auto">
                <div class="col-12 col-lg-8">
                    <div class="article-container">
                        <article>
                            <header>
                                <h1 class="article-title">MultiBank Philippines Hosts Investors Night 2019</h1>
                                <div class="article-date">2019-12-07 | News</div>
                                <p>&nbsp</p>
                            </header>
                        </article>
                        <img src="https://cms.multibankfx.com/../../../public_files/images/blog/PH_Investor_Night_en.jpg" class="article-img" />
                        <div class="article-body">
                            <p class="article-date"></p>
                            <p class="article-paragraph">
                                <p class="MsoNoSpacing">Dec 7, 2019-</p>
                                <p class="MsoNoSpacing">On 7<sup>th</sup> December, the MultiBank Philippines
                                    team hosted Investors Night 2019 at the luxurious Dusit Thani Manila hotel in
                                    the heart of Makati City. The evening gala celebrated MultiBank’s partnership
                                    with ZAREPATH Group, one of our core partners in the Philippines who are also
                                    our valued IBs.
                                </p>
                                <p class="MsoNoSpacing">The evening was filled with exciting programs, including
                                    performances from local entertainers and impersonators, raffle events where guests
                                    took home luxury designer watches and travel packages. MultiBank Philippines
                                    also presented the Group to new investors who attended the gala, showcasing our
                                    achievements in 2019 and sharing our vision for a strengthened partnership in
                                    the upcoming year.
                                </p>
                                <p class="MsoNoSpacing">
                                    <video allowfullscreen="allowfullscreen" class="article-video" src="../public_files/video/ph_office_investor_night.mp4" controls="controls"></video>
                                </p>
                        </div>
                    </div>
                    <style>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoyNg==' />
                            <input type='hidden' name='token' value='$2y$10$PiwEw7mPsI4n6rzQYnDo0ebB.T09dEEOQgjSW8JTSINwUmKibY9Da' />
                            <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:22] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:24] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:25] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:26] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-philippines-hosts-investors-night-2019?web=true' />
                    ...
                    <div class="mex-h5 text-1e32a3 text-center c859">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-chosen-best-FX-CFD-broker-2019.html" class="text-left article-thumbnail-text c933">MultiBank Chosen as Best FX & CFD Broker (Europe & Asia) 2019 by International Investor Magazine
                                </a>
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="news_20181110.html" class="text-left article-thumbnail-text c1066">
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-named-best-financial-derivatives-broker-2019.html" class="text-left article-thumbnail-text c1196">
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="../cdn-cgi/l/email-protection.html#f59686b5988099819c97949b9e938ddb969a98">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDoyNg==' />
                    <input type='hidden' name='token' value='$2y$10$wQIUS7e8czKKxUpuxqKsDu.MwI.lqmXIDJnhHDN/gC8bpKq8dVTdW' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:22] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:24] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:25] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:26] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/article/multibank-philippines-hosts-investors-night-2019?web=true' />
